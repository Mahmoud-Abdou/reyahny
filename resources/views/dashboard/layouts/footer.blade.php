...
<!-- Hide Scroll To Top Ends-->
  ...
  <footer class="footer footer-static footer-light">
    <p class="clearfix blue-grey lighten-2 mb-0"><span class="float-md-left d-block d-md-inline-block mt-25"> {{ __('lang.COPYRIGHT') }} &copy; {{ date("Y")}}<a class="text-bold-800 grey darken-2" href="https://solidsolutionsegypt.com/" target="_blank">Solid,</a>All rights Reserved</span><span class="float-md-right d-none d-md-block">Hand-crafted & Made with<i class="feather icon-heart pink"></i></span>
