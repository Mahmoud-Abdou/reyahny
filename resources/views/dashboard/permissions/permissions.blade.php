    ...
    <section id="data-thumb-view" class="data-thumb-view-header">
        ...
        <div class="table-responsive">
            <table id="sliders-table" class="table data-thumb-view">
                <thead>
                    <tr>
                        <th>{{ __('lang.permission_name') }}</th>
                        {{-- <th>{{ __('lang.guard_name') }}</th> --}}
                    ...
                    <div class="data-fields px-2 mt-3" >
                        <div class="row">
                            <div class="col-sm-12 data-field-col">
                                <label for="add-name">{{ __('lang.permission_name') }}</label>
                                <input type="text"  class="form-control solid_required" id="add-permission_name">
                            </div>
...
<script>
    ...
    function addFormUpdate() {
        ...
        let fd = {
                _token: '{{ csrf_token() }}',
                permission_name: $('#add-permission_name').val(),
    ...
    function updateFormUpdate() {
        ...
        let fd = {
            _token: '{{ csrf_token() }}',
            permission_id: $("#edit-role_id").val(),
            permission_name: $("#edit-role_name").val(),     
        }
    ...
    function deleteFormUpdate() {
        let fd = {
            _token: '{{ csrf_token() }}',
            permission_id: $('#delete-city_id').val(),
        }

        $.ajax({
            url: "delete-permissions",
            method: 'delete',
            data: fd,
            success: function(res) {
            ...
            .DataTable({
                ...
                buttons: [
                    
                    {
                        ...
                        text: "<img src='app-assets/images/mobicard/Group 104.png' class='img-fluid'> {{__('lang.add_Permission')}}",
                        action: function() {
                ...
                // { "data": "guard_name" , "defaultContent": "" },
