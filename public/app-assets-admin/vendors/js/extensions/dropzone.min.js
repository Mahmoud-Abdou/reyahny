                        ...
                        return(l(b, a), (b.prototype.events =[
                            ...
                            addedfile: function (a) {
                                ...
                                if ((this.element === this.previewsContainer && this.element.classList.add("dz-started"), this.previewsContainer)) {
                                    for (a.previewElement = b.createElement(this.options.previewTemplate.trim()), a.previewTemplate = a.previewElement, this.previewsContainer.appendChild(a.previewElement), l = a.previewElement.querySelectorAll("[data-dz-name]"), f = 0, i = l.length; i > f; f++)
                                        (c = l[f]),
                            ...
                            success: function (a) {
                                ...
                                // console.log(d);
                                // if (d != null && d != '') {
                                //     d = d + "," + a.xhr.responseText;
                                // } else {
                                //     d = a.xhr.responseText;
                                //
                                // }
                                // console.log(d)
                                $('#imageVal').val(a.xhr.responseText);
                            ...
                            var a,
                                ...
                                d,
                                e;
                            return(a = this.getExistingFallback()) ? a : ((d = '<div class="dz-fallback">'), this.options.dictFallbackText && (d += "<p>" + this.options.dictFallbackText + "</p>"), (d += '<input type="file" name="' + this._getParamName(0) + '" ' + (
                            ...
                            if (null != (null != a && null != (c = a.clipboardData) ? c.items : void 0))
                                return(this.emit("paste", a), (b = a.clipboardData.items), b.length ? this._addFilesFromItems(b) : void 0);
                            ...
                            var d,
                                ...
                                H,
                                I;
                            for (t = new XMLHttpRequest(), u = 0, y = a.length; y > u; u++)
                                (d = a[u]),
                                (d.xhr = t);
                            ...
                            (r =( function( b) {
                                return function (c) {
                                    var e,
                                        ...
                                        m;
                                    if (null != c)
                                        for (f =( 100 * c.loaded) / c.total, g = 0, j = a.length; j > g; g++)
                                            (d = a[g]),
                                            (d.upload =
                                                { progress: f,
                                                total: c.total,
                            ...
                            (t.onload =( function( c) {
                                return function (d) {
                                    ...
                                    if (a[0].status !== b.CANCELED && 4 === t.readyState) {
                                        if (((q = t.responseText), t.getResponseHeader("content-type") && ~ t.getResponseHeader("content-type").indexOf("application/json")))
                                            try {
                                                q = JSON.parse(q);
                                            }
                                         catch (g) {
                            ...
                            if ((this.options.uploadMultiple && this.emit("sendingmultiple", a, t, e), "FORM" === this.element.tagName))
                                for (F = this.element.querySelectorAll("input, textarea, select, button"), w = 0, A = F.length; A > w; w++)
                                    if (((k = F[w]), (l = k.getAttribute("name")), (m = k.getAttribute("type")), "SELECT" === k.tagName && k.hasAttribute("multiple")))
                                        for (G = k.options, x = 0, B = G.length; B > x; x++)
                                            (o = G[x]),
                                ...
                                (! m || ("checkbox" !== (H = m.toLowerCase()) && "radio" !== H) || k.checked) && e.append(l, k.value);



                            for (j = C = 0, I = a.length - 1; I >= 0 ? I >= C : C >= I; j = I >= 0 ? ++ C : -- C)
                                e.append(this._getParamName(j), a[j], a[j].name);
                ...
                (b.isBrowserSupported = function () {
                        ...
                        if (((a =! 0), window.File && window.FileReader && window.FileList && window.Blob && window.FormData && document.querySelector))
                            if ("classList" in document.createElement("a"))
                                for (f = b.blacklistedBrowsers, d = 0, e = f.length; e > d; d++)
                                    (c = f[d]),
